  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_mafia:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_mafia:handcuff', GetPlayerServerId(player))
              end
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_mafia:getVehicleInfos', function(infos)
  ...
  ESX.TriggerServerCallback('esx_mafia:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafia:buy', function(hasEnoughMoney)
