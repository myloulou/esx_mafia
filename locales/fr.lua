Locales['fr'] = {
  ...
  ['owner'] = 'propriétaire : ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'mafia - Prendre Arme',
  ['put_weapon_menu'] = 'mafia - Déposer Arme',
  ['buy_weapon_menu'] = 'mafia - Acheter Armes',
  ...
  ['quantity'] = 'Quantité',
  ['get_stock'] = 'mafia - Prendre Objet',
  ['put_stock'] = 'mafia - Déposer Objet',
  -- Notifications
  ['from'] = '~s~ à ~b~',
